...
const loyalty_jobs_1 = require("./loyalty.jobs");
let LoyaltyModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            controllers: [loyalty_controller_1.LoyaltyController],
            providers: [loyalty_service_1.LoyaltyService, loyalty_jobs_1.LoyaltyJobs],
    ...
    var LoyaltyModule = class {
        ...
        static {
            ...
            LoyaltyModule = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
    };
    return LoyaltyModule = _classThis;
})();
