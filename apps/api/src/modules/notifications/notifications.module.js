...
let NotificationsModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            imports: [
                ...
                (0, common_1.forwardRef)(() => automation_module_1.AutomationModule), // Para acessar WhatsAppService (forwardRef para evitar ciclo)
                subscriptions_module_1.SubscriptionsModule, // Para acessar AddonsService (consumo de quota)
            ],
