...
exports.buildLexiconTelemetry = buildLexiconTelemetry;
/**
 * Cria evento de telemetria a partir do resultado do LexiconResolver.
 * Puro — não faz I/O. O caller decide onde gravar.
 */
function buildLexiconTelemetry(match, lexiconEnabled, overrideReason) {
    if (!lexiconEnabled) {
        return {
    ...
    const decision = match.needsConfirmation
        ? 'ASK_CONFIRM'
        : 'ASSUME';
...
//# sourceMappingURL=lexicon-telemetry.js.map