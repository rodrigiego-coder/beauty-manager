...
## 9. Healthcheck (monitoramento)

Endpoint publico de healthcheck (sem autenticacao):

- **URL:** `https://app.agendasalaopro.com.br/api/healthz`
...
## 10. Server Block (sanitized / reference)
