...
exports.resolveAptProfessionals = resolveAptProfessionals;
exports.formatProfessionalList = formatProfessionalList;
exports.fuzzyMatchProfessional = fuzzyMatchProfessional;
/**
 ...
 */
function resolveAptProfessionals(serviceId, professionals, assignments) {
    ...
    const aptIds = new Set(assignments
 ...
 */
function formatProfessionalList(professionals) {
 ...
 */
function fuzzyMatchProfessional(text, professionals) {
...
//# sourceMappingURL=professional-resolver.js.map