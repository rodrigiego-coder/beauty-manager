...
let AppointmentsModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            imports: [
                users_1.UsersModule,
                (0, common_1.forwardRef)(() => notifications_1.NotificationsModule), // Para notificações WhatsApp automáticas (forwardRef para evitar ciclo)
                (0, common_1.forwardRef)(() => triage_module_1.TriageModule), // Para verificar se serviço requer triagem
