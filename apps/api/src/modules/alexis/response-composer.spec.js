...
describe('ResponseComposerService - Pure Functions (DELTA)', () => {
    ...
    describe('getGreeting', () => {
        it('should return greeting based on current hour', () => {
            const greeting = (0, response_composer_service_1.getGreeting)();
    ...
    describe('shouldGreet', () => {
        ...
        it('should return true if greeted more than 2 hours ago', () => {
            ...
            expect((0, response_composer_service_1.shouldGreet)(threeHoursAgo)).toBe(true);
        });
        it('should return false if greeted within 2 hours', () => {
            const oneHourAgo = new Date();
            oneHourAgo.setHours(oneHourAgo.getHours() - 1);
            expect((0, response_composer_service_1.shouldGreet)(oneHourAgo)).toBe(false);
        });
        it('should respect custom window hours', () => {
            const threeHoursAgo = new Date();
            threeHoursAgo.setHours(threeHoursAgo.getHours() - 3);
            // Com janela de 2 horas, 3 horas atras deve saudar
            expect((0, response_composer_service_1.shouldGreet)(threeHoursAgo, 2)).toBe(true);
            // Com janela de 4 horas, 3 horas atras nao deve saudar
            expect((0, response_composer_service_1.shouldGreet)(threeHoursAgo, 4)).toBe(false);
        });
    });
    // =====================================================
    // isProductIntent
    ...
    describe('isProductIntent', () => {
        it('should return true for PRODUCT_INFO', () => {
            expect((0, response_composer_service_1.isProductIntent)('PRODUCT_INFO')).toBe(true);
        });
        it('should return true for PRICE_INFO', () => {
            expect((0, response_composer_service_1.isProductIntent)('PRICE_INFO')).toBe(true);
        });
        it('should return false for other intents', () => {
            expect((0, response_composer_service_1.isProductIntent)('GREETING')).toBe(false);
            expect((0, response_composer_service_1.isProductIntent)('SCHEDULE')).toBe(false);
            expect((0, response_composer_service_1.isProductIntent)('GENERAL')).toBe(false);
        });
    });
    // =====================================================
    // getProductCta
    ...
    describe('getProductCta', () => {
        it('should return CTA for product intents', () => {
            const cta = (0, response_composer_service_1.getProductCta)();
    ...
    describe('getNameQuestion', () => {
        it('should return polite name question', () => {
            const question = (0, response_composer_service_1.getNameQuestion)();
    ...
    describe('getIntroduction', () => {
        it('should include Alexis and salon name', () => {
            const intro = (0, response_composer_service_1.getIntroduction)('Salao da Maria');
    ...
    describe('composeResponse', () => {
        it('should compose first contact with name question', () => {
            const response = (0, response_composer_service_1.composeResponse)({
                greeting: 'Boa tarde',
...
//# sourceMappingURL=response-composer.spec.js.map