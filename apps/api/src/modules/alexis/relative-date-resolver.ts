 ...
 */
const RELATIVE_DATE_PATTERNS: { pattern: RegExp; offsetDays: number; label: string }[] = [
 ...
 */
export function resolveRelativeDate(message: string): RelativeDateResult {
 ...
 */
function formatRelativeDate(offsetDays: number, label: string): string {
