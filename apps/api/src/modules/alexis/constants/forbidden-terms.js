...
exports.INTENT_KEYWORDS = exports.ALEXIS_SYSTEM_PROMPT = exports.COMMAND_RESPONSES = exports.COMMANDS = exports.BLOCKED_RESPONSE = exports.SAFE_REPLACEMENTS = exports.FORBIDDEN_REGEX = void 0;
// REGEX PARA TERMOS PROIBIDOS
exports.FORBIDDEN_REGEX = {
...
exports.BLOCKED_RESPONSE = `Para esse tipo de avaliação, o ideal é conversar diretamente com um profissional durante o atendimento presencial.
...
exports.COMMAND_RESPONSES = {
    HUMAN_TAKEOVER: 'Ops! Agora você será atendida por alguém da nossa equipe. Estou por aqui se precisar depois. 😊',
    AI_RESUME: 'Voltei! Se quiser, posso continuar te ajudando por aqui. 💇‍♀️',
};
// SYSTEM PROMPT PARA A IA ALEXIS
const ALEXIS_SYSTEM_PROMPT = (salonName) => `Você é ALEXIS, a assistente virtual oficial do ${salonName}.
...
exports.ALEXIS_SYSTEM_PROMPT = ALEXIS_SYSTEM_PROMPT;
