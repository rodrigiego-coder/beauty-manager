...
let CalendarModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            ...
            providers: [google_calendar_service_1.GoogleCalendarService, calendar_sync_service_1.CalendarSyncService],
            exports: [google_calendar_service_1.GoogleCalendarService, calendar_sync_service_1.CalendarSyncService],
        })];
