...
const message_scheduler_service_1 = require("./message-scheduler.service");
const automation_jobs_1 = require("./automation.jobs");
const alexis_module_1 = require("../alexis/alexis.module");
let AutomationModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            imports: [(0, common_1.forwardRef)(() => alexis_module_1.AlexisModule)],
            controllers: [automation_controller_1.AutomationController, zapi_webhook_controller_1.ZapiWebhookController],
            providers: [
                automation_service_1.AutomationService,
                whatsapp_service_1.WhatsAppService,
                sms_service_1.SMSService,
                message_scheduler_service_1.MessageSchedulerService,
                automation_jobs_1.AutomationJobs,
            ],
            exports: [
                automation_service_1.AutomationService,
                whatsapp_service_1.WhatsAppService,
